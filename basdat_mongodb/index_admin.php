                    ...
                    <ul class="nav nav-pills flex-column mb-auto">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="#"><p>This web only made by 5 person</p>
                            <p>Myself, Afrizal,</p>
                            <p>Nur Ayu, Aryan, and Hayyin</p></a></li>
                            </ul>
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="crud.php">Create, Update, Delete</a></li>
                            </ul>
                            <p class="d-inline-flex gap-1">
                        </div>
                    </ul>
            ...
            <div class="col px-4">
                <div class="container px-5 mt-4 my-auto">
                    <div class="text-center">
                        ...
                        <h5>you are logged in as <b>admin</b></h5>
                    </div><br>
